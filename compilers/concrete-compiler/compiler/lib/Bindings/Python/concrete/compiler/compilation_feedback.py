...
class MoreCircuitCompilationFeedback:
    ...
    @staticmethod
    def count(circuit_feedback: CircuitCompilationFeedback, *, operations: Set[PrimitiveOperation]) -> int:
        """
    ...
    @staticmethod
    def count_per_tag(circuit_feedback: CircuitCompilationFeedback, *, operations: Set[PrimitiveOperation]) -> Dict[str, int]:
        """
